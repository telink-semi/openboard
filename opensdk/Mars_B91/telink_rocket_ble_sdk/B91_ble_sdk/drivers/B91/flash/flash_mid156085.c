 ...
 *              If an abnormality occurs, the firmware and user data may be rewritten, resulting in the final Product failure)
 */
void flash_write_status_mid156085(unsigned short data, mid156085_write_status_bit_e bit)
{
...
void flash_lock_mid156085(mid156085_lock_block_e data)
{
	...
	flash_write_status_mid156085(data, FLASH_WRITE_STATUS_BP_MID156085);
}
...
{
	flash_write_config_mid156085(0x00,FLASH_WRITE_CONFIGURE_WPS_MID156085);
	flash_write_status_mid156085(FLASH_LOCK_NONE_MID156085, FLASH_WRITE_STATUS_BP_MID156085);
}
